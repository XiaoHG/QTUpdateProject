...
#include "../../ReadUDisk/fileselectwidget.h"
...
void FileSelectWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FileSelectWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileSelectWidget::clicked)) {
                *result = 0;
                return;
            }
        }
