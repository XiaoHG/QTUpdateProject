...
QT_MOC_LITERAL(1, 14, 18), // "sigCloseMainWindow"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 9), // "sigUpdate"
QT_MOC_LITERAL(4, 44, 20), // "slotUpdateBtnClicked"
QT_MOC_LITERAL(5, 65, 17) // "slotUpdateTimeOut"

    },
    "AutoUpdaterUI\0sigCloseMainWindow\0\0"
...
void AutoUpdaterUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AutoUpdaterUI::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AutoUpdaterUI::sigCloseMainWindow)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AutoUpdaterUI::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AutoUpdaterUI::sigUpdate)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void AutoUpdaterUI::sigCloseMainWindow()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void AutoUpdaterUI::sigUpdate()
{
